          ...
          <Col md="5" className="justify-content-md-center">
            ...
            <Row className="justify-content-md-center">
              <Col md="auto">
                <>
                  <br></br>
                  <h1 style={{ color: '#007bff' }}>Krzysztof Wancerski</h1>
            ...
            <Row className="justify-content-md-center">
              <Button href='/projects' variant="primary" style={{ fontSize: '20px', margin: '10px', padding: '10px 20px', width: '80%' }}><b>Design Engineering Portfolio</b></Button>
            </Row>
            <Row className="justify-content-md-center">
              <Button href='/CV' variant="primary" style={{ fontSize: '20px', margin: '10px', padding: '10px 20px', width: '80%' }}><b>Current CV</b></Button>
            </Row>
            <Row className="justify-content-md-center">
