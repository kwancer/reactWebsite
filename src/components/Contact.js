...
const Contact = () => {
    return (
        <div className="App">
            <NavBar />
            <Container>
                <Row style={{ marginLeft: "5%", marginRight: "5%", marginTop: "2%", textAlign: "center" }}>
                    <Col>
                        <h1 style={{ color: "#007bff", fontWeight: "bold" }}>Contact</h1>
                        <p style={{ fontSize: "1.2em", color: "#555" }}>Below are some key information on how to find me and reach me.</p>
                    </Col>
                </Row>
                <Row md={2} s={1} style={{ marginLeft: "5%", marginRight: "5%", marginTop: "2%" }}>
                    <Col>
                        ...
                        <p style={{ fontSize: "1.1em", color: "#555" }}>Here are some of my contact details:</p>
                    ...
                    <Col>
                        ...
                        <p style={{ fontSize: "1.1em", color: "#555" }}>Here are some of my social media profiles:</p>
                ...
                <Row style={{ marginLeft: "5%", marginRight: "5%", marginTop: "2%" }}>
                    <Col>
                        ...
                        <p style={{ fontSize: "1.1em", color: "#555" }}>These are the places I call home.</p>
